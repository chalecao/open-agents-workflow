...
export const metadata: Metadata = {
  title: "Download MultiAgent",
  description:
    "Download MultiAgent for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download MultiAgent",
    description:
      "Get the MultiAgent desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
