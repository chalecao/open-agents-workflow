...
description: Install the MultiAgent CLI and start the agent daemon.
---
...
This configures the CLI for MultiAgent Cloud, opens your browser for login, discovers your workspaces, and starts the agent daemon.
