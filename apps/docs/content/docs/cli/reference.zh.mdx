---
title: CLI Reference
description: Complete command reference for the MultiAgent CLI and agent daemon.
---
...
When connecting to a self-hosted MultiAgent instance, point the CLI to your server before logging in:
