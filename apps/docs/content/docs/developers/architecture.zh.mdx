---
title: Architecture
description: Technical architecture of the MultiAgent platform.
---

## Overview

MultiAgent is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
