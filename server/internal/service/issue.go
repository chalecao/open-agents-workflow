...
type IssueCreateParams struct {
	...
	AllowDuplicate bool
	// HandoffData is the optional handoff_data JSONB blob to seed the
	// issue with. nil means "use the column default" (i.e. '{}'::jsonb).
	// The handler validates the object shape + 8 KiB cap before this
	// service is called.
	HandoffData []byte
}
