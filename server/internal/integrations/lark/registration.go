...
//     and an expiry. MultiAgent renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to MultiAgent. Empty defaults
	// to "multica".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with MultiAgent's `source`
...
// cannot attribute installs back to MultiAgent in their analytics.
//
