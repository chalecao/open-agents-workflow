...
// install path is per-agent (each MultiAgent Agent gets exactly one Bot —
...
function InstallationRow({
  ...
  const { t } = useT("settings");
  // The bot is bound 1:1 to a MultiAgent Agent (per the (workspace_id,
  // agent_id) UNIQUE in lark_installation). Render the MultiAgent agent's
