    ...
    api
      ...
      .then((cfg) => {
        ...
        configStore.getState().setAuthConfig({
          ...
          // Same omit-when-false contract as workspace_creation_disabled:
          // old servers return no field, the gate is off, anyone can create.
          adminEmailsConfigured: cfg.admin_emails_configured === true,
        });
